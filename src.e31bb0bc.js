...
function onThemeSwitchToggleClick(event) {
  if (event.target.checked) {
    activeTheme.theme = theme.DARK, refs.themeBody.classList.replace(theme.LIGHT, theme.DARK) || refs.themeBody.classList.add(activeTheme.theme);
  } else {
    activeTheme.theme = theme.LIGHT, refs.themeBody.classList.replace(theme.DARK, theme.LIGHT) || refs.themeBody.classList.add(activeTheme.theme);
  }
...
function onActiveTheme() {
  var getActiveThem = localStorage.getItem('activeThem');
  var getActiveChecked = localStorage.getItem('checked');
